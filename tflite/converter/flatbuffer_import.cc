...
#include "tflite/converter/flatbuffer_operator.h"
#include "tflite/converter/ir/tfl_ops.h"
#include "tflite/converter/offset_buffer.h"
#include "tflite/converter/quantization/common/quantization_lib/quantization_traits.h"
#include "tflite/converter/quantization/ir/QuantOps.h"
#include "tflite/converter/schema/mutable/debug_metadata_generated.h"
...
#include "tflite/converter/utils/metadata_utils.h"
#include "tflite/converter/utils/shape_and_size_utils.h"
...
StatusOr<Operation*> BuildConstOp(const tflite::TensorT& tensor,
  ...
  if (use_stablehlo_constant) {
    ...
    auto vhlo_val = mlir::vhlo::TensorV1Attr::get(
        ...
        mlir::DenseElementsAttr::getFromRawBuffer(shaped_type, val_ref));
    auto op =
