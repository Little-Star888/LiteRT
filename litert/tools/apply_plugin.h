...
#ifndef ODML_LITERT_LITERT_TOOLS_APPLY_PLUGIN_H_
#define ODML_LITERT_LITERT_TOOLS_APPLY_PLUGIN_H_
...
struct ApplyPluginRun {
  ...
  // NOTE: Keep this after the environment so the options are destroyed before
  // the environment which has the RuntimeProxy.
  Options options;
};
...
#endif  // ODML_LITERT_LITERT_TOOLS_APPLY_PLUGIN_H_
